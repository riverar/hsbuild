...
namespace Vala {
	...
	[CCode (cheader_filename = "valagee.h")]
	public class ReadOnlyCollection<G> : Vala.CollectionObject, Vala.Iterable<G>, Vala.Collection<G> {
		public ReadOnlyCollection (Vala.Collection<G>? collection = null);
		public Vala.Collection<G> collection { set; }
	}
	[CCode (cheader_filename = "valagee.h")]
	public class ReadOnlyList<G> : Vala.CollectionObject, Vala.Iterable<G>, Vala.Collection<G>, Vala.List<G> {
		public ReadOnlyList (Vala.List<G>? list = null);
		public Vala.List<G> list { set; }
	}
	[CCode (cheader_filename = "valagee.h")]
	public class ReadOnlyMap<K,V> : Vala.CollectionObject, Vala.Map<K,V> {
		public ReadOnlyMap (Vala.Map<K,V>? map = null);
		public Vala.Map<K,V> map { set; }
	}
	[CCode (cheader_filename = "valagee.h")]
	public class ReadOnlySet<G> : Vala.CollectionObject, Vala.Iterable<G>, Vala.Collection<G>, Vala.Set<G> {
		public ReadOnlySet (Vala.Set<G>? @set = null);
		public Vala.Set<G> @set { set; }
	}
	[CCode (cheader_filename = "valagee.h")]
