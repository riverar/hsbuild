/* vala-1.0.vapi generated by valac.exe, do not modify. */
...
namespace Vala {
	...
	public class CCodeArrayModule : Vala.CCodeMethodCallModule {
		public CCodeArrayModule (Vala.CCodeGenerator codegen, Vala.CCodeModule? next);
	...
	public class CCodeAssignmentModule : Vala.CCodeMemberAccessModule {
		public CCodeAssignmentModule (Vala.CCodeGenerator codegen, Vala.CCodeModule? next);
		public override void visit_assignment (Vala.Assignment assignment);
	}
	[CCode (cheader_filename = "vala.h")]
	public class CCodeBaseModule : Vala.CCodeModule {
		...
		public Vala.DataType genumvalue_type;
		...
		public CCodeBaseModule (Vala.CCodeGenerator codegen, Vala.CCodeModule? next);
		...
		protected string generate_destroy_func_wrapper (Vala.DataType type);
		...
		public override Vala.CCodeIdentifier get_value_setter_function (Vala.DataType type_reference);
		public override Vala.CCodeIdentifier get_value_taker_function (Vala.DataType type_reference);
		...
		public virtual bool variable_accessible_in_finally (Vala.LocalVariable local);
	...
	public class CCodeControlFlowModule : Vala.CCodeMethodModule {
		public CCodeControlFlowModule (Vala.CCodeGenerator codegen, Vala.CCodeModule? next);
	...
	[CCode (ref_function = "vala_ccode_declaration_space_ref", unref_function = "vala_ccode_declaration_space_unref", cheader_filename = "vala.h")]
	...
	public class CCodeDelegateModule : Vala.CCodeArrayModule {
		public CCodeDelegateModule (Vala.CCodeGenerator codegen, Vala.CCodeModule? next);
	...
	public class CCodeMemberAccessModule : Vala.CCodeControlFlowModule {
		public CCodeMemberAccessModule (Vala.CCodeGenerator codegen, Vala.CCodeModule? next);
		public override void visit_member_access (Vala.MemberAccess expr);
	}
	[CCode (cheader_filename = "vala.h")]
	public class CCodeMethodCallModule : Vala.CCodeAssignmentModule {
		public CCodeMethodCallModule (Vala.CCodeGenerator codegen, Vala.CCodeModule? next);
		public override void visit_method_call (Vala.MethodCall expr);
	}
	[CCode (cheader_filename = "vala.h")]
	public class CCodeMethodModule : Vala.CCodeStructModule {
		public CCodeMethodModule (Vala.CCodeGenerator codegen, Vala.CCodeModule? next);
	...
	[CCode (ref_function = "vala_ccode_module_ref", unref_function = "vala_ccode_module_unref", cheader_filename = "vala.h")]
	public abstract class CCodeModule {
		...
		public virtual void visit_boolean_literal (Vala.BooleanLiteral expr);
		...
		public virtual void visit_character_literal (Vala.CharacterLiteral expr);
		...
		public virtual void visit_null_literal (Vala.NullLiteral expr);
		...
		public virtual void visit_string_literal (Vala.StringLiteral expr);
	...
	public class CCodeStructModule : Vala.CCodeBaseModule {
		public CCodeStructModule (Vala.CCodeGenerator codegen, Vala.CCodeModule? next);
	...
	public class Constant : Vala.Member, Vala.Lockable {
		public Constant (string name, Vala.DataType type_reference, Vala.Expression? initializer, Vala.SourceReference? source_reference, Vala.Comment? comment = null);
		public override void accept (Vala.CodeVisitor visitor);
		public override void accept_children (Vala.CodeVisitor visitor);
		public override bool check (Vala.SemanticAnalyzer analyzer);
	...
	public class DBusClientModule : Vala.DBusModule {
		public DBusClientModule (Vala.CCodeGenerator codegen, Vala.CCodeModule? next);
	...
	public class DBusModule : Vala.GAsyncModule {
		public DBusModule (Vala.CCodeGenerator codegen, Vala.CCodeModule? next);
	...
	public class DBusServerModule : Vala.DBusClientModule {
		public DBusServerModule (Vala.CCodeGenerator codegen, Vala.CCodeModule? next);
	...
	public class EnumValue : Vala.Symbol {
		public EnumValue (string name, Vala.SourceReference? source_reference = null, Vala.Comment? comment = null);
		public override void accept (Vala.CodeVisitor visitor);
		public override void accept_children (Vala.CodeVisitor visitor);
		public override bool check (Vala.SemanticAnalyzer analyzer);
		...
		public void process_attributes ();
		public void set_cname (string cname);
		public EnumValue.with_value (string name, Vala.Expression value, Vala.SourceReference? source_reference = null, Vala.Comment? comment = null);
	...
	public class Field : Vala.Member, Vala.Lockable {
		public Field (string name, Vala.DataType field_type, Vala.Expression? initializer, Vala.SourceReference? source_reference = null, Vala.Comment? comment = null);
		public override void accept (Vala.CodeVisitor visitor);
		public override void accept_children (Vala.CodeVisitor visitor);
		public override bool check (Vala.SemanticAnalyzer analyzer);
	...
	public class GAsyncModule : Vala.GSignalModule {
		public GAsyncModule (Vala.CCodeGenerator codegen, Vala.CCodeModule? next);
		public override void generate_cparameters (Vala.Method m, Vala.CCodeDeclarationSpace decl_space, Vala.Map<int,Vala.CCodeFormalParameter> cparam_map, Vala.CCodeFunction func, Vala.CCodeFunctionDeclarator? vdeclarator = null, Vala.Map<int,Vala.CCodeExpression>? carg_map = null, Vala.CCodeFunctionCall? vcall = null, int direction = 3);
		public override void generate_method_declaration (Vala.Method m, Vala.CCodeDeclarationSpace decl_space);
	...
	public class GDBusClientModule : Vala.GDBusModule {
		public GDBusClientModule (Vala.CCodeGenerator codegen, Vala.CCodeModule? next);
		public override void generate_dynamic_method_wrapper (Vala.DynamicMethod method);
		public override void generate_interface_declaration (Vala.Interface iface, Vala.CCodeDeclarationSpace decl_space);
		public Vala.CCodeConstant get_dbus_timeout (Vala.Symbol symbol);
		public override void visit_interface (Vala.Interface iface);
	...
	public class GDBusModule : Vala.GVariantModule {
		public GDBusModule (Vala.CCodeGenerator codegen, Vala.CCodeModule? next);
		public static string? get_dbus_name (Vala.TypeSymbol symbol);
		public static string get_dbus_name_for_member (Vala.Symbol symbol);
		public override Vala.CCodeFragment register_dbus_info (Vala.ObjectTypeSymbol sym);
		public override void visit_error_domain (Vala.ErrorDomain edomain);
	...
	public class GDBusServerModule : Vala.GDBusClientModule {
		public GDBusServerModule (Vala.CCodeGenerator codegen, Vala.CCodeModule? next);
		public static string dbus_result_name (Vala.Method m);
	...
	public class GErrorModule : Vala.CCodeDelegateModule {
		public GErrorModule (Vala.CCodeGenerator codegen, Vala.CCodeModule? next);
	...
	public class GObjectModule : Vala.GTypeModule {
		public GObjectModule (Vala.CCodeGenerator codegen, Vala.CCodeModule? next);
	...
	public class GSignalModule : Vala.GObjectModule {
		public GSignalModule (Vala.CCodeGenerator codegen, Vala.CCodeModule? next);
	...
	public class GTypeModule : Vala.GErrorModule {
		public GTypeModule (Vala.CCodeGenerator codegen, Vala.CCodeModule? next);
	...
	public class GVariantModule : Vala.GAsyncModule {
		public GVariantModule (Vala.CCodeGenerator codegen, Vala.CCodeModule? next);
	...
	public abstract class Member : Vala.Symbol {
		public Member (string? name, Vala.SourceReference? source_reference, Vala.Comment? comment = null);
		public override void accept (Vala.CodeVisitor visitor);
	...
	public class PropertyAccessor : Vala.Symbol {
		public PropertyAccessor (bool readable, bool writable, bool construction, Vala.DataType? value_type, Vala.Block? body, Vala.SourceReference? source_reference);
		public override void accept (Vala.CodeVisitor visitor);
		public override void accept_children (Vala.CodeVisitor visitor);
		public override bool check (Vala.SemanticAnalyzer analyzer);
		public override Vala.List<string> get_cheader_filenames ();
