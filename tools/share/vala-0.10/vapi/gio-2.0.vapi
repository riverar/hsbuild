...
namespace GLib {
	...
	namespace Bus {
		...
		[CCode (cheader_filename = "gio/gio.h")]
		public static T get_proxy_for_connection_sync<T> (GLib.DBusConnection connection, string? name, string object_path, GLib.Cancellable? cancellable = null) throws GLib.IOError;
		[CCode (cheader_filename = "gio/gio.h")]
