...
namespace GLib {
	...
	public class InputStream : GLib.Object {
		...
		public bool read_all ([CCode (array_length_type = "gsize")] uint8[] buffer, out size_t bytes_read = null, GLib.Cancellable? cancellable = null) throws GLib.IOError;
	...
	public class OutputStream : GLib.Object {
		...
		public bool write_all ([CCode (array_length_type = "gsize")] uint8[] buffer, out size_t bytes_written = null, GLib.Cancellable? cancellable = null) throws GLib.IOError;
