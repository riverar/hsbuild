...
@copy "%~dp0\hsbuild\bin\x86\Release\hsbuild.console.exe" "%ProgramFiles%\HSBuild\bin\hsbuild.exe"
@copy "%~dp0\hsbuild\bin\x86\Release\HSbuild.Core.dll" "%ProgramFiles%\HSBuild\bin"
@copy "%~dp0\hsbuild\bin\x86\Release\ICSharpCode.SharpZipLib.dll" "%ProgramFiles%\HSBuild\bin"
